...
send_telegram_message(f"Programm started {datetime.now(ZoneInfo('Asia/Kolkata')).strftime('%H:%M:%S')}",Admin)                
                    ...
                    try:
                        ...
                        if stock in self.printed:
                          if current_vol // self.printed[stock]+2>= avg_vol :
                            ...
                            msg = (
                                f"🔥 Realerting Stock incresed spike * {self.printed[stock]+2} *\n\n"
